---
title: Tines alternative for DevOps to build workflows as code
sidebar_label: Tines
description: Compare Flowpipe to Tines as an alternative solution to automate cloud operations. coordinate people and pipelines, and build workflows as code.
---
...
| **Composable modules** | <a href="https://flowpipe.io/docs/build/mod-dependencies" target="_blank">Yes</a> | Limited |
| **Terms** | Open source | Proprietary, free limited self-hosting, call for pricing |

# When to choose Flowpipe over Tines

Tines is a good choice for teams seeking a no-code, automation platform for a wide range of tasks and workflows across different teams
